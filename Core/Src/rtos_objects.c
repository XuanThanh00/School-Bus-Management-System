...
static StackType_t  s_stack_idle [128];           static StaticTask_t s_tcb_idle;
static StackType_t  s_stack_timer[128];           static StaticTask_t s_tcb_timer;
...
/* ── FreeRTOS static-allocation hooks (required when dynamic alloc = 0) ── */

void vApplicationGetIdleTaskMemory(StaticTask_t **ppTCB,
                                   StackType_t  **ppStack,
                                   uint32_t      *pSize) {
    *ppTCB   = &s_tcb_idle;
    *ppStack = s_stack_idle;
    *pSize   = 128U;
}
